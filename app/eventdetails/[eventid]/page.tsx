					...
					<div className="grid grid-cols-1 gap-4">
						...
						<CardSpotlight className="p-4 bg-transparent border rounded-xl border-cardborder1">
							<div className="relative z-20">
								...
								<div className="list-disc list-inside" dangerouslySetInnerHTML={{ __html: Event?.date || "" }} />
								<p>Time: <b>{Event?.time}</b></p>
								<p>Mode: <b>{Event?.mode}</b></p>
						...
						<CardSpotlight className="p-4 bg-transparent border rounded-xl border-cardborder1 md:col-span-2">
							<div className="relative z-20">
								<SparklesText className="text-center mb-2" text={Event?.id == "11" ? "Details" : "Rules"} />
								...
								<CardSpotlight className="p-4 bg-transparent border rounded-xl border-cardborder1">
									<div className="relative z-20">
										...
										<div className="flex justify-center items-center flex-col">
											<h1 className="font-retro text-6xl sm:text-8xl ios">{Event?.teamnumber}</h1>
